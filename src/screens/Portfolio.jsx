...
const Portfolio = () => {
    ...
    const [handler, setHandler] = useState(null); // New state for handler
    ...
    const fetchAllData = async () => {
        try {
            ...
            setHandler(handlerRes); // Store handler result
            ...
            <div className={styles.dashboard}>
                ...
                <div className={styles.mainSection}>
                    ...
                    <div className={styles.dashboardContent}>
                        ...
                        {handler?handler.message.handler.map(data=><DepositPlanCard plan={data}/>):<></>}
                                ...
                                <div className={styles.rightCard}>
                                    ...
                                    <div className={styles.infoRow}>
                                        ...
                                        <div className={styles.infoBox}>
                                            ...
                                            <p className={styles.value}>{investment?.isActive ? investment?.date : '---'}</p>
                                        </div>
                                    </div>
